                                    ...
                                    #for AddNoise in [False,True]:
                                                ...
                                                #for epsilon in epsilon_vals:
                                                    ...
                                                    if (cnt in Completed_Outputs):
                                                        ...
                                                        proc = Process(target=PrivBayes, args=(dataset_choice,M,split_choice,k,str_choice,AddNoise,epsilon,AddNoise1,epsilon1,AddNoise2,epsilon2,classfication_choice,repetitions,cnt,data,testing_data,Attr_domains,Child_Parents,NumOfAttrs,attributes,lock,Datasets,[]))
                                                        procs.append(proc)
